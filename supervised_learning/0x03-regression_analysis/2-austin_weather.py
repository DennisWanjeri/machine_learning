...
axes.scatter(range(1, 366), df_first_year.TempAvgF, label='Raw Data')
axes.plot(range(1, 366), rolling, c='r', label='{} day moving average'.format(window))
